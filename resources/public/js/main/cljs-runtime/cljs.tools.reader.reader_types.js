...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_45662 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_45662(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_45663 = (function (reader){
var x__4422__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_45663(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_45664 = (function (reader,ch){
var x__4422__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_45664(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_45665 = (function (reader){
var x__4422__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_45665(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_45673 = (function (reader){
var x__4422__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_45673(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_45674 = (function (reader){
var x__4422__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_45674(reader);
}
});
...
var G__45733 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__45734 = s.append(c);
c = G__45733;
s = G__45734;
continue;
}
