...
(clojure.test.check.properties.ErrorResult.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4376__auto__,k45452,else__4377__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k45452,else__4377__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4396__auto__,p__45475){
var vec__45482 = p__45475;
var k__4397__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45482,(0),null);
var v__4398__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45482,(1),null);
...
(clojure.test.check.properties.ErrorResult.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__45451){
var self__ = this;
var G__45451__$1 = this;
return (new cljs.core.RecordIter((0),G__45451__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"error","error",-978969032)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(clojure.test.check.properties.ErrorResult.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this45453,other45454){
var self__ = this;
var this45453__$1 = this;
return (((!((other45454 == null)))) && ((this45453__$1.constructor === other45454.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this45453__$1.error,other45454.error)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this45453__$1.__extmap,other45454.__extmap)));
}));
...
(clojure.test.check.properties.ErrorResult.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4381__auto__,k__4382__auto__,G__45451){
var self__ = this;
var this__4381__auto____$1 = this;
var pred__45511 = cljs.core.keyword_identical_QMARK_;
var expr__45512 = k__4382__auto__;
if(cljs.core.truth_((pred__45511.cljs$core$IFn$_invoke$arity$2 ? pred__45511.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"error","error",-978969032),expr__45512) : pred__45511.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__45512)))){
return (new clojure.test.check.properties.ErrorResult(G__45451,self__.__meta,self__.__extmap,null));
} else {
return (new clojure.test.check.properties.ErrorResult(self__.error,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4382__auto__,G__45451),null));
}
}));
...
(clojure.test.check.properties.ErrorResult.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4373__auto__,G__45451){
var self__ = this;
var this__4373__auto____$1 = this;
return (new clojure.test.check.properties.ErrorResult(self__.error,G__45451,self__.__extmap,self__.__hash));
}));
 ...
 */
clojure.test.check.properties.map__GT_ErrorResult = (function clojure$test$check$properties$map__GT_ErrorResult(G__45458){
var extmap__4413__auto__ = (function (){var G__45562 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__45458,new cljs.core.Keyword(null,"error","error",-978969032));
if(cljs.core.record_QMARK_(G__45458)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__45562);
} else {
return G__45562;
}
})();
return (new clojure.test.check.properties.ErrorResult(new cljs.core.Keyword(null,"error","error",-978969032).cljs$core$IFn$_invoke$arity$1(G__45458),null,cljs.core.not_empty(extmap__4413__auto__),null));
});
