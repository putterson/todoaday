...
var no_stacktrace_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42441__$1,new cljs.core.Keyword(null,"no-stacktrace?","no-stacktrace?",1701072694));
var stacktrace_fonts = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42441__$1,new cljs.core.Keyword(null,"stacktrace-fonts","stacktrace-fonts",830799382));
var map__42442 = data;
...
var level = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42442__$1,new cljs.core.Keyword(null,"level","level",1290497552));
var _QMARK_err = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42442__$1,new cljs.core.Keyword(null,"?err","?err",549653299));
var msg_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42442__$1,new cljs.core.Keyword(null,"msg_","msg_",-1925147000));
var _QMARK_ns_str = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42442__$1,new cljs.core.Keyword(null,"?ns-str","?ns-str",2012733966));
var _QMARK_file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42442__$1,new cljs.core.Keyword(null,"?file","?file",1533429675));
var hostname_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42442__$1,new cljs.core.Keyword(null,"hostname_","hostname_",-2091647379));
var timestamp_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42442__$1,new cljs.core.Keyword(null,"timestamp_","timestamp_",-954533417));
var _QMARK_line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42442__$1,new cljs.core.Keyword(null,"?line","?line",-631853385));
...
var G__42545 = (i__4731__auto___42543 + (1));
i__4731__auto___42543 = G__42545;
continue;
} else {
}
break;
...
/** @this {Function} */
(taoensso.timbre.swap_config_BANG_.cljs$lang$applyTo = (function (seq42458){
var G__42459 = cljs.core.first(seq42458);
var seq42458__$1 = cljs.core.next(seq42458);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__42459,seq42458__$1);
}));
...
return ((function (){var G__42472 = taoensso.timbre.valid_level(x);
return (taoensso.timbre._levels_map.cljs$core$IFn$_invoke$arity$1 ? taoensso.timbre._levels_map.cljs$core$IFn$_invoke$arity$1(G__42472) : taoensso.timbre._levels_map.call(null,G__42472));
})() >= (function (){var G__42473 = taoensso.timbre.valid_level(y);
return (taoensso.timbre._levels_map.cljs$core$IFn$_invoke$arity$1 ? taoensso.timbre._levels_map.cljs$core$IFn$_invoke$arity$1(G__42473) : taoensso.timbre._levels_map.call(null,G__42473));
})());
});
...
var fexpr__42477 = taoensso.timbre._compile_ns_filter(whitelist,blacklist);
return (fexpr__42477.cljs$core$IFn$_invoke$arity$1 ? fexpr__42477.cljs$core$IFn$_invoke$arity$1(_QMARK_ns) : fexpr__42477.call(null,_QMARK_ns));
}));
/**
...
var vec__42488 = vargs;
var v0 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42488,(0),null);
...
var _QMARK_msg_fmt = (cljs.core.truth_(fmt_msg_QMARK_)?(function (){var vec__42494 = vargs__$1;
var v0__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42494,(0),null);
return v0__$1;
})():null);
...
var _QMARK_msg_fmt = (cljs.core.truth_(fmt_msg_QMARK_)?(function (){var vec__42498 = vargs__$1;
var v0__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42498,(0),null);
return v0__$1;
})():null);
var vargs__$2 = (cljs.core.truth_(fmt_msg_QMARK_)?taoensso.timbre.vrest(vargs__$1):vargs__$1);
...
var instant_42561 = taoensso.encore.now_dt();
var context_42562 = taoensso.timbre._STAR_context_STAR_;
var vargs_42563 = cljs.core.deref(vargs_);
var vec__42514_42564 = taoensso.timbre.parse_vargs(_QMARK_err,msg_type,vargs_42563);
var _QMARK_err_42565__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42514_42564,(0),null);
var _QMARK_meta_42566 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42514_42564,(1),null);
var _QMARK_msg_fmt_42567 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42514_42564,(2),null);
var vargs_42568__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42514_42564,(3),null);
var data_42569 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2((function (){var or__4120__auto__ = _QMARK_base_data;
if(cljs.core.truth_(or__4120__auto__)){
return or__4120__auto__;
} else {
return cljs.core.PersistentArrayMap.EMPTY;
}
})(),cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword(null,"instant","instant",655498374),new cljs.core.Keyword(null,"config","config",994861415),new cljs.core.Keyword(null,"vargs","vargs",-966597273),new cljs.core.Keyword(null,"?file","?file",1533429675),new cljs.core.Keyword(null,"error-level?","error-level?",778415885),new cljs.core.Keyword(null,"?ns-str","?ns-str",2012733966),new cljs.core.Keyword(null,"level","level",1290497552),new cljs.core.Keyword(null,"?err","?err",549653299),new cljs.core.Keyword(null,"context","context",-830191113),new cljs.core.Keyword(null,"?line","?line",-631853385),new cljs.core.Keyword(null,"?err_","?err_",789480858),new cljs.core.Keyword(null,"?meta","?meta",-793560773),new cljs.core.Keyword(null,"?msg-fmt","?msg-fmt",-852453891)],[instant_42561,config,vargs_42568__$1,_QMARK_file,(function (){var fexpr__42521 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"fatal","fatal",1874419888),null,new cljs.core.Keyword(null,"error","error",-978969032),null], null), null);
return (fexpr__42521.cljs$core$IFn$_invoke$arity$1 ? fexpr__42521.cljs$core$IFn$_invoke$arity$1(level) : fexpr__42521.call(null,level));
})(),_QMARK_ns_str,level,_QMARK_err_42565__$1,context_42562,_QMARK_line,(new cljs.core.Delay((function (){
return _QMARK_err_42565__$1;
}),null)),_QMARK_meta_42566,_QMARK_msg_fmt_42567]));
var _QMARK_data_42570 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,mf){
...
}),data_42569,new cljs.core.Keyword(null,"middleware","middleware",1462115504).cljs$core$IFn$_invoke$arity$1(config));
var temp__5735__auto___42578 = _QMARK_data_42570;
if(cljs.core.truth_(temp__5735__auto___42578)){
var data_42579__$1 = temp__5735__auto___42578;
var map__42523_42580 = data_42579__$1;
var map__42523_42581__$1 = (((((!((map__42523_42580 == null))))?(((((map__42523_42580.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__42523_42580.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__42523_42580):map__42523_42580);
var vargs_42582__$2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42523_42581__$1,new cljs.core.Keyword(null,"vargs","vargs",-966597273));
var data_42583__$2 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(data_42579__$1,new cljs.core.Keyword(null,"vargs_","vargs_",552132148),(new cljs.core.Delay((function (){
return vargs_42582__$2;
}),null)));
var data_42584__$3 = taoensso.encore.assoc_nx.cljs$core$IFn$_invoke$arity$variadic(data_42583__$2,new cljs.core.Keyword(null,"msg_","msg_",-1925147000),(new cljs.core.Delay((function (){
var G__42529 = msg_type;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__42529)){
return "";
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"p","p",151049309),G__42529)){
return taoensso.timbre.str_join(vargs_42582__$2);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"f","f",-1597136552),G__42529)){
if(typeof _QMARK_msg_fmt_42567 === 'string'){
} else {
...
return taoensso.encore.format_STAR_(_QMARK_msg_fmt_42567,vargs_42582__$2);
} else {
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__42529)].join('')));
...
return cljs.core.hash(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [callsite_id,_QMARK_msg_fmt_42567,cljs.core.get.cljs$core$IFn$_invoke$arity$3(_QMARK_meta_42566,new cljs.core.Keyword(null,"hash","hash",-13781596),vargs_42582__$2)], null));
}),null))], 0));
var output_fn1_42585 = taoensso.encore.memoize_(cljs.core.get.cljs$core$IFn$_invoke$arity$3(config,new cljs.core.Keyword(null,"output-fn","output-fn",1600951539),taoensso.timbre.default_output_fn));
...
return cljs.core.not((function (){var G__42534 = cljs.core.force(new cljs.core.Keyword(null,"hash_","hash_",-827203612).cljs$core$IFn$_invoke$arity$1(data_42584__$3));
return (rl_fn.cljs$core$IFn$_invoke$arity$1 ? rl_fn.cljs$core$IFn$_invoke$arity$1(G__42534) : rl_fn.call(null,G__42534));
})());
}
})();
if(rate_limit_okay_QMARK_){
var map__42535 = appender;
...
var apfn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42535__$1,new cljs.core.Keyword(null,"fn","fn",-1175266204));
var async_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42535__$1,new cljs.core.Keyword(null,"async?","async?",1523057758));
...
return output_fn1_42585;
} else {
return f;
}
})();
var output_ = (new cljs.core.Delay((function (){
return (output_fn.cljs$core$IFn$_invoke$arity$1 ? output_fn.cljs$core$IFn$_invoke$arity$1(data_42584__$3) : output_fn.call(null,data_42584__$3));
}),null));
var data__$4 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(data_42584__$3,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"appender-id","appender-id",-1917983538),id,new cljs.core.Keyword(null,"appender","appender",1267426510),appender,new cljs.core.Keyword(null,"output-fn","output-fn",1600951539),output_fn,new cljs.core.Keyword(null,"output_","output_",-36797880),output_], null));
...
var args__4736__auto__ = [];
var len__4730__auto___42610 = arguments.length;
var i__4731__auto___42611 = (0);
while(true){
if((i__4731__auto___42611 < len__4730__auto___42610)){
args__4736__auto__.push((arguments[i__4731__auto___42611]));

var G__42612 = (i__4731__auto___42611 + (1));
i__4731__auto___42611 = G__42612;
continue;
} else {
}
break;
...
/** @this {Function} */
(taoensso.timbre.str_println.cljs$lang$applyTo = (function (seq42539){
