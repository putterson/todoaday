 ...
 *   lookup refs.
 */
com.fulcrologic.fulcro.algorithms.denormalize.follow_ref = (function com$fulcrologic$fulcro$algorithms$denormalize$follow_ref(state_map,p__48241){
var vec__48243 = p__48241;
var table = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48243,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48243,(1),null);
var ref = vec__48243;
 ...
 */
com.fulcrologic.fulcro.algorithms.denormalize.ref_key = (function com$fulcrologic$fulcro$algorithms$denormalize$ref_key(p__48247){
var vec__48248 = p__48247;
var table = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48248,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48248,(1),null);
var ref = vec__48248;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Symbol(null,"_","_",-1201019570,null),id)){
return table;
} else {
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (n,p__48267){
var map__48270 = p__48267;
...
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48270__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
...
com.fulcrologic.fulcro.algorithms.denormalize.add_join_BANG_ = (function com$fulcrologic$fulcro$algorithms$denormalize$add_join_BANG_(n,p__48312,entity,state_map,parent_node,idents_seen){
...
var join_node = map__48314__$1;
var query = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48314__$1,new cljs.core.Keyword(null,"query","query",-1288509510));
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48314__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
...
com.fulcrologic.fulcro.algorithms.denormalize.add_union_BANG_ = (function com$fulcrologic$fulcro$algorithms$denormalize$add_union_BANG_(n,p__48333,entity,state_map,idents_seen){
...
var join_node = map__48334__$1;
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48334__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
var link_join_QMARK_ = com.fulcrologic.fulcro.algorithms.denormalize.lookup_ref_QMARK_(key);
...
var union_key__GT_query = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (result,p__48340){
...
var node = map__48341__$1;
var union_key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48341__$1,new cljs.core.Keyword(null,"union-key","union-key",1529707234));
...
var vec__48343 = lookup_ref;
var table = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48343,(0),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var e = temp__5733__auto__;
var temp__5733__auto____$1 = (function (){var G__48346 = cljs.core.first(v);
return (union_key__GT_query.cljs$core$IFn$_invoke$arity$1 ? union_key__GT_query.cljs$core$IFn$_invoke$arity$1(G__48346) : union_key__GT_query.call(null,G__48346));
})();
if(cljs.core.truth_(temp__5733__auto____$1)){
var target_ast_node = temp__5733__auto____$1;
 ...
 */
com.fulcrologic.fulcro.algorithms.denormalize.denormalize = (function com$fulcrologic$fulcro$algorithms$denormalize$denormalize(p__48352,current_entity,state_map,idents_seen){
...
var top_node = map__48353__$1;
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48353__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var children = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48353__$1,new cljs.core.Keyword(null,"children","children",-940561982));
...
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Symbol(null,"*","*",345799209,null),(function (){var G__48355 = nil_nodes;
var G__48355__$1 = (((G__48355 == null))?null:cljs.core.first(G__48355));
if((G__48355__$1 == null)){
return null;
} else {
return new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(G__48355__$1);
}
})());
} else {
...
var G__48359 = result_node__$1;
var G__48359__$1 = (((G__48359 == null))?null:cljs.core.persistent_BANG_(G__48359));
if((G__48359__$1 == null)){
return null;
} else {
return com.fulcrologic.fulcro.algorithms.denormalize.with_time(G__48359__$1,com.fulcrologic.fulcro.algorithms.denormalize._STAR_denormalize_time_STAR_);
}
});
/**
...
var G__48360 = com.fulcrologic.fulcro.algorithms.denormalize.denormalize(ast,starting_entity,state_map,cljs.core.PersistentArrayMap.EMPTY);
if((G__48360 == null)){
return null;
} else {
return com.fulcrologic.fulcro.algorithms.denormalize.with_time(G__48360,com.fulcrologic.fulcro.algorithms.denormalize._STAR_denormalize_time_STAR_);
}
});
/**
...
var G__48361 = props;
var G__48361__$1 = (((G__48361 == null))?null:cljs.core.meta(G__48361));
if((G__48361__$1 == null)){
return null;
} else {
return new cljs.core.Keyword("com.fulcrologic.fulcro.algorithms.denormalize","time","com.fulcrologic.fulcro.algorithms.denormalize/time",-375164969).cljs$core$IFn$_invoke$arity$1(G__48361__$1);
}
});
