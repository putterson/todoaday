...
if((!((ident == null)))){
return cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$4((function (){var G__50166 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(query,cljs.core.first(ident));
var G__50167 = data__$1;
var G__50168 = refs;
var G__50169 = union_seen;
var G__50170 = transform;
return (com.fulcrologic.fulcro.algorithms.normalize.normalize_STAR_.cljs$core$IFn$_invoke$arity$5 ? com.fulcrologic.fulcro.algorithms.normalize.normalize_STAR_.cljs$core$IFn$_invoke$arity$5(G__50166,G__50167,G__50168,G__50169,G__50170) : com.fulcrologic.fulcro.algorithms.normalize.normalize_STAR_.call(null,G__50166,G__50167,G__50168,G__50169,G__50170));
...
var vec__50221 = com.fulcrologic.fulcro.algorithms.do_not_use.join_entry(expr);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50221,(0),null);
var sel = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50221,(1),null);
...
var G__50287 = cljs.core.next(q);
var G__50288 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(ret,k,i);
q = G__50287;
ret = G__50288;
continue;
} else {
var G__50289 = cljs.core.next(q);
var G__50290 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(ret,k,x);
q = G__50289;
ret = G__50290;
continue;
}
...
var xs = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1(((function (q,ret,vec__50221,k,sel,recursive_QMARK_,union_entry,sel__$1,class$,v,expr,data__$1){
return (function (p1__50164_SHARP_){
return (com.fulcrologic.fulcro.algorithms.normalize.normalize_STAR_.cljs$core$IFn$_invoke$arity$5 ? com.fulcrologic.fulcro.algorithms.normalize.normalize_STAR_.cljs$core$IFn$_invoke$arity$5(sel__$1,p1__50164_SHARP_,refs,union_entry,transform) : com.fulcrologic.fulcro.algorithms.normalize.normalize_STAR_.call(null,sel__$1,p1__50164_SHARP_,refs,union_entry,transform));
});})(q,ret,vec__50221,k,sel,recursive_QMARK_,union_entry,sel__$1,class$,v,expr,data__$1))
),v);
if((!((((class$ == null)) || ((!(com.fulcrologic.fulcro.components.has_ident_QMARK_(class$)))))))){
var is = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1(((function (q,ret,xs,vec__50221,k,sel,recursive_QMARK_,union_entry,sel__$1,class$,v,expr,data__$1){
return (function (p1__50165_SHARP_){
return com.fulcrologic.fulcro.components.get_ident.cljs$core$IFn$_invoke$arity$2(class$,p1__50165_SHARP_);
});})(q,ret,xs,vec__50221,k,sel,recursive_QMARK_,union_entry,sel__$1,class$,v,expr,data__$1))
),xs);
if(cljs.core.vector_QMARK_(sel__$1)){
if(cljs.core.empty_QMARK_(is)){
} else {
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(refs,((function (q,ret,is,xs,vec__50221,k,sel,recursive_QMARK_,union_entry,sel__$1,class$,v,expr,data__$1){
return (function (refs__$1){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(((function (q,ret,is,xs,vec__50221,k,sel,recursive_QMARK_,union_entry,sel__$1,class$,v,expr,data__$1){
return (function (m,p__50226){
var vec__50227 = p__50226;
var i = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50227,(0),null);
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50227,(1),null);
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$4(m,i,cljs.core.merge,x);
});})(q,ret,is,xs,vec__50221,k,sel,recursive_QMARK_,union_entry,sel__$1,class$,v,expr,data__$1))
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(((function (q,ret,is,xs,vec__50221,k,sel,recursive_QMARK_,union_entry,sel__$1,class$,v,expr,data__$1){
return (function (ret__$1,p__50232){
var vec__50233 = p__50232;
var i = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50233,(0),null);
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50233,(1),null);
...
var G__50299 = cljs.core.next(q);
var G__50300 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(ret,k,is);
q = G__50299;
ret = G__50300;
continue;
} else {
var G__50302 = cljs.core.next(q);
var G__50303 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(ret,k,xs);
q = G__50302;
ret = G__50303;
continue;
}
...
if((v == null)){
var G__50304 = cljs.core.next(q);
var G__50305 = ret;
q = G__50304;
ret = G__50305;
continue;
} else {
var G__50306 = cljs.core.next(q);
var G__50307 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(ret,k,v);
q = G__50306;
ret = G__50307;
continue;
...
var v = cljs.core.get.cljs$core$IFn$_invoke$arity$2(data__$1,k);
if((v == null)){
var G__50309 = cljs.core.next(q);
var G__50310 = ret;
q = G__50309;
ret = G__50310;
continue;
} else {
var G__50312 = cljs.core.next(q);
var G__50313 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(ret,k,v);
q = G__50312;
ret = G__50313;
continue;
}
