...
var clojure$test$check$random$IRandom$rand_long$dyn_44732 = (function (rng){
...
return clojure$test$check$random$IRandom$rand_long$dyn_44732(rng);
}
});

var clojure$test$check$random$IRandom$rand_double$dyn_44733 = (function (rng){
var x__4422__auto__ = (((rng == null))?null:rng);
...
return clojure$test$check$random$IRandom$rand_double$dyn_44733(rng);
}
});

var clojure$test$check$random$IRandom$split$dyn_44735 = (function (rng){
var x__4422__auto__ = (((rng == null))?null:rng);
...
return clojure$test$check$random$IRandom$split$dyn_44735(rng);
}
});

var clojure$test$check$random$IRandom$split_n$dyn_44745 = (function (rng,n){
var x__4422__auto__ = (((rng == null))?null:rng);
...
return clojure$test$check$random$IRandom$split_n$dyn_44745(rng,n);
}
});
...
var G__44711 = z;
if(((24) > (function (){var G__44712 = clojure.test.check.random.bxoubsr(z,(1));
return (clojure.test.check.random.longs.bit_count.cljs$core$IFn$_invoke$arity$1 ? clojure.test.check.random.longs.bit_count.cljs$core$IFn$_invoke$arity$1(G__44712) : clojure.test.check.random.longs.bit_count.call(null,G__44712));
})())){
return clojure.test.check.random.longs.bit_xor(G__44711,clojure.test.check.random.mix_gamma_const_3);
} else {
return G__44711;
}
});
...
var G__44753 = state_SINGLEQUOTE__SINGLEQUOTE_;
var G__44754 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(ret,new_rng);
state__$1 = G__44753;
ret = G__44754;
continue;
}
...
return (function (){
return new cljs.core.Keyword(null,"returned","returned",-2020439163).cljs$core$IFn$_invoke$arity$1(cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(a,(function (p__44722){
...
var state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44723__$1,new cljs.core.Keyword(null,"state","state",-1988618099));
var vec__44726 = clojure.test.check.random.split(state);
var r1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44726,(0),null);
var r2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44726,(1),null);
