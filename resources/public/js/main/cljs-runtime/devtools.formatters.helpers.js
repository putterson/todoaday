...
var G__42511 = devtools.prefs.pref(v);
v = G__42511;
continue;
} else {
return v;
...
}catch (e42383){var _e__41173__auto__ = e42383;
return false;
}})();
...
}catch (e42402){var _e__41173__auto__ = e42402;
return false;
}})();
...
}catch (e42407){var _e__41173__auto__ = e42407;
return false;
}}
}
});
...
var vec__42477 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42477,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42477,(1),null);
...
return cljs.core.some((function (p1__42484_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__42484_SHARP_);
}),template);
});
