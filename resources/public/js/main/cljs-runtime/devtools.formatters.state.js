...
var i__4731__auto___42136 = (0);
while(true){
if((i__4731__auto___42136 < len__4730__auto___42132)){
args__4736__auto__.push((arguments[i__4731__auto___42136]));

var G__42138 = (i__4731__auto___42136 + (1));
i__4731__auto___42136 = G__42138;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.state.update_current_state_BANG_.cljs$lang$applyTo = (function (seq42099){
var G__42100 = cljs.core.first(seq42099);
var seq42099__$1 = cljs.core.next(seq42099);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__42100,seq42099__$1);
}));
...
return cljs.core.some((function (p1__42111_SHARP_){
return (p1__42111_SHARP_ === object);
}),history);
});
